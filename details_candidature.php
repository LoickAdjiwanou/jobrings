            ...
            <div class="container">    
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="">
                        ...
                        <?php
                            echo $_SESSION['prenom'].'<br/>'.$_SESSION['nom'].'<br/><font size="4px">Profil: Entreprise</font>';
                        ?>
                        </p></strong>
                    </a>
                </div>
                        ...
                        <div class="col-md-4">
                            <div class="blog_item m-top-20" style="border:1px solid lightgrey;box-shadow:3px 3px 3px 3px;padding-top:5px;padding-bottom:0px;padding-left:15px;background-color:white;">
                                ...
                                <div style="padding-bottom: 6px;text-align:left;color:darkblue; display:flex; flex-direction:row; justify-content:space-between;">
                                    <b><li style="list-style-type:none;"><a href="traitement_depostuler.php?idpostuler=<?php echo $resultats['id']; ?>">
                                    <?php
                                        if($sup == 0){
                                            echo 'Retirer candidature';
                                        }
                                        else{
                                            echo '<b><li style="list-style-type:none;"><a href="traitement_repostuler.php?idpostuler='.$d.'">Postuler</a></li></b>';
                                        }
                                    ?></a></li></b>
                                </div>
                            </div>
