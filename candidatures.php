            ...
            <div class="container">
                <div class="row">
                    <div class="main_blog text-center roomy-100">
                        ...
                        <?php
                            $join = $bdd -> query('SELECT * FROM publications p INNER JOIN postuler s ON p.id = s.id_job WHERE nomcandidat = "'.$_SESSION['nom'].'"');
                        ...
                        <div class="col-md-4">
                            <div class="blog_item m-top-20" style="border:1px solid lightgrey;box-shadow:3px 3px 3px 3px;padding-top:5px;padding-bottom:0px;padding-left:15px;background-color:white;">
                                ...
                                <div style="padding-bottom: 6px;text-align:left;color:darkblue;">
                                    <b><li style="list-style-type:none;"><a href="details_candidature.php?idposte=<?php echo $resultats['id'];?>&sup=0">Détails</a></li></b>
                                </div>
                            </div>
                        </div>
                        <?php  
