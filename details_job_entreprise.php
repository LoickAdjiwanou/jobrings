...
<head>
    <meta charset="utf-8">
    <title>JoBrings - Détails Job</title>
                    ...
                    <div class="main_blog text-center roomy-100">
                        ...
                        <div class="col-md-4">
                            <div class="blog_item m-top-20" style="border:1px solid lightgrey;box-shadow:3px 3px 3px 3px;padding-top:5px;padding-bottom:0px;padding-left:15px;background-color:white;">
                                ...
                                <?php
                                    echo '<b><li style="list-style-type:none;margin-right:12px;"><a href="traitement_listecandidats.php?idposte='.$d.'">Voir candidature(s)</a></li></b>';
                                
                                    echo '<b><li style="list-style-type:none;margin-right:12px;"><a href="traitement_supprimer.php?idposte='.$d.'">Supprimer</a></li></b>';
                                ?>
                                </div>
                            </div>
                        </div>
