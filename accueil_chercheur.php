            ...
            <div class="container">    
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li><a href="jobs_chercheur.php?nb=0">Jobs</a></li>
                        <li><a href="candidatures.php?sup=0">Candidatures</a></li>
                        <li><a href="suivis.php?svr=0">Suivis</a></li>
                        <li><a href="profil_chercheur.php">Profil</a></li>  
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <section id="hello" class="home bg-mega">
            ...
            <div class="container">
                <div class="row">
                    <div class="main_home">
                        <div class="home_text">
                            <h1 class="text-white">Explorer les jobs<br/>et trouvez l'emploi de vos rêves</h1>
                        </div>
    
                        <div class="home_btns m-top-40" data-in="fadeInDown" data-out="fadeOutUp">
                            <a href="#blog" class="btn btn-primary m-top-20">Explorer</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="main_blog text-center roomy-100">
                        <div class="col-sm-8 col-sm-offset-2">
                            <div class="head_title text-center">
                                ...
                                <p>Retrouvez les jobs les plus récemment postés </p>
                            </div>
                        </div>

                        <?php
                        $reqs = $bdd ->query("SELECT * FROM publications LIMIT 0,6");
                        ...
                        <div class="col-md-4">
                            <div class="blog_item m-top-20" style="border:1px solid lightgrey;box-shadow:3px 3px 3px 3px;padding-top:5px;padding-bottom:0px;padding-left:15px;background-color:white;">
                                ...
                                <?php
                                    ...
                                    echo '<h5><b>Domaine:</b> '.$resultats['duree'].'</h5>';
                                    echo '<h5><b>Expérience requise:</b> '.$resultats['experience'].'</h5>';
                                    echo '<h5><b>Domaine:</b> '.$resultats['salaire'].'</h5>';
                                ?>
                                </div>
