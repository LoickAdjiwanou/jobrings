                    ...
                    <div class="main_blog text-center roomy-100">
                        <div class="col-sm-8 col-sm-offset-2">
                            <div class="head_title text-center">
                                ...
                                <p>Retrouver vos publications d'offre d'emploi</p>
                            </div>
                        </div>

                        <?php    
                            $reqs = $bdd ->prepare('SELECT * FROM publications WHERE nomentreprise = :nn ORDER BY id DESC');
                            $reqs->execute(array(
                                'nn'=>$_SESSION['nom']
                            ));
                        ...
                        <div class="col-md-4">
                            <div class="blog_item m-top-20" style="border:1px solid lightgrey;box-shadow:3px 3px 3px 3px;padding-top:5px;padding-bottom:0px;padding-left:15px;background-color:white;">
                                ...
                                <div style="padding-bottom: 6px;text-align:left;color:darkblue;">
                                    <b><li style="list-style-type:none;"><a href="details_job_entreprise.php?idposte=<?php echo $resultats['id']; ?>">Détails</a></li></b>
                                </div>
                            </div>
                        </div>
                        <?php
