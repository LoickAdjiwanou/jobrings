	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="traitement_creer_compte.php" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="mode" value="entreprise">
